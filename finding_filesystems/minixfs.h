...
#define NUM_INDIRECT_INODES (sizeof(data_block) / sizeof(data_block_number))
...
/*
*  Creates a file located at path, return NULL if inode already exists or cannot
*  be created.
*
 ...
 *      possible filesize (calculate this from NUM_DIRECT_INODES and
 *      NUM_INDIRECT_INODES) fail without writing any data and set errno to
 * ENOSPC
 *
